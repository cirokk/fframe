...
const LANGS = {
  "pt-BR": {
    ...
    "cmt.you": "Você",
    "cmt.range": "{from} – {to}",
    "cmt.markIn": "＋ marcar trecho",
    "cmt.markOut": "marcar fim (fim > início)",
    "cmt.clearOut": "✕ limpar trecho",
    "cmt.rangeStart": "início {from} · agora marque o fim",
    "cmt.rangeStarted": "Início do trecho em {from}. Vá até o fim e clique em “marcar fim”.",
    "cmt.rangeEndAfter": "O fim do trecho precisa vir depois do início.",
    "cmt.reply": "responder",
    "cmt.replyPlaceholder": "Responder…",
    "cmt.replySend": "Responder",
    "cmt.replies": "{n} resposta(s)",
    "pv.play": "Reproduzir",
    "pv.pause": "Pausar",
    "pv.frameBack": "Frame anterior",
    "pv.frameFwd": "Próximo frame",
    "pv.mute": "Mudo",
    "pv.unmute": "Som",
    "pv.fullscreen": "Tela cheia",
    "pv.fps": "Quadros por segundo (para o timecode e o passo de frame)",
    "pv.shortcuts": "Espaço/K: play · J/L: -/+ · ←/→: frame",
  ...
  en: {
    ...
    "cmt.you": "You",
    "cmt.range": "{from} – {to}",
    "cmt.markIn": "＋ mark range",
    "cmt.markOut": "mark end (end > start)",
    "cmt.clearOut": "✕ clear range",
    "cmt.rangeStart": "start {from} · now mark the end",
    "cmt.rangeStarted": "Range start at {from}. Go to the end and click “mark end”.",
    "cmt.rangeEndAfter": "The range end must come after the start.",
    "cmt.reply": "reply",
    "cmt.replyPlaceholder": "Reply…",
    "cmt.replySend": "Reply",
    "cmt.replies": "{n} repl(y/ies)",
    "pv.play": "Play",
    "pv.pause": "Pause",
    "pv.frameBack": "Previous frame",
    "pv.frameFwd": "Next frame",
    "pv.mute": "Mute",
    "pv.unmute": "Unmute",
    "pv.fullscreen": "Fullscreen",
    "pv.fps": "Frames per second (for timecode and frame stepping)",
    "pv.shortcuts": "Space/K: play · J/L: -/+ · ←/→: frame",
